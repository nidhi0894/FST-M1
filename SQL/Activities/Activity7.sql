...
SELECT MIN(purchase_amount) AS "Total Purchase Amount" FROM orders;

SELECT MIN(purchase_amount) AS "Minimum Purchase Amount" FROM orders;

SELECT COUNT(salesman_id) AS "Total Saleman" FROM orders;

SELECT COUNT(DISTINCT salesman_id) AS "Total Saleman" FROM orders;
